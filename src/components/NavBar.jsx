  ...
  return (
    <nav className="w-full relative z-50">
      ...
      <div className="bg-white py-4 px-4 md:px-8 flex justify-between items-center shadow-sm relative">
        ...
        {/* Mobile Menu */}
        {open && (
          <div className="absolute top-full left-0 w-full bg-white shadow-md flex flex-col items-center gap-6 py-6 text-sm font-bold text-gray-700 md:hidden z-40">
            <a href="#courses" className="hover:text-[#FF6B00]" onClick={() => setOpen(false)}>COURSES</a>
            <a href="#why-borcelle" className="hover:text-[#FF6B00]" onClick={() => setOpen(false)}>WHY BORCELLE</a>
            <a href="#student-life" className="hover:text-[#FF6B00]" onClick={() => setOpen(false)}>STUDENT LIFE</a>
            <a href="#testimonials" className="hover:text-[#FF6B00]" onClick={() => setOpen(false)}>TESTIMONIALS</a>
            <a href="#blog" className="hover:text-[#FF6B00]" onClick={() => setOpen(false)}>BLOGS</a>
            ...
            <button
              ...
              className="bg-[#FF6B00] text-white px-6 py-2 rounded-full font-bold text-sm hover:bg-white hover:text-black transition-colors shadow-lg">
              ENROLL NOW
            </button>
          </div>
        )}
